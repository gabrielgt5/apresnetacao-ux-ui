...
export function SlideCover({ slide }: { slide: any }) {
  return (
    <div className="w-full h-full flex items-center justify-center p-8 relative">
      ...
      >
        ...
        <div className="flex-1 bg-black rounded-[2rem] sm:rounded-[3rem] p-4 sm:p-8 relative overflow-hidden flex items-center justify-center border-[8px] sm:border-[16px] border-gray-800 shadow-inner">
          ...
          <div className="relative z-0 w-full aspect-square max-w-md flex items-center justify-center">
             <GlobeHemisphereWest weight="duotone" className="text-white/70 w-[80%] h-[80%] animate-[spin_60s_linear_infinite]" />
             
             <svg viewBox="0 0 200 200" className="absolute inset-0 w-full h-full animate-[spin_20s_linear_infinite] drop-shadow-md">
                <path id="curve" d="M 20,100 A 80,80 0 1,1 180,100 A 80,80 0 1,1 20,100" fill="transparent" />
                <text className="text-[1.35rem] font-black uppercase tracking-widest" style={{ fill: '#ffffff' }}>
                  <textPath href="#curve" startOffset="0%">
                    • O MUNDO DO SOFTWARE • O MUNDO DO SOFTWARE 
                  </textPath>
                </text>
             </svg>
          </div>
